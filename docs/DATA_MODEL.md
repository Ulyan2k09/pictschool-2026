...
- `10` — пример комплексной команды: две клетки вперед;
- `11` — пример комплексной команды: разворот на 180 градусов;
- `12` — пример комплексной команды: шаг вправо боковым маневром;
- `13` — пример комплексной команды: шаг влево боковым маневром.
