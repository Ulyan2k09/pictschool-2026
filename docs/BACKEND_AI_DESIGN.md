...
3. Backend валидирует список команд: базовые `1..4`, расширенные `10..13`, длина `1..5`.
...
- `encoder` — генерация массива базовых команд `1..4` или расширенных команд платформы.
...
- в массиве есть код вне поддерживаемого набора;
...
submit_turn(round_id, actor, commands)
  ...
  validate commands (supported command set, max 5)
