...
- в один ход доступно от `1` до `5` движений;
...
- Подтверждает прием TCP-сообщения на уровне соединения.
...
6. После успешной TCP-отправки backend применяет движение локально по правилам поля.
