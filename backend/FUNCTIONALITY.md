...
- `agent` стартует в `{ "x": 9, "y": 9 }`, направление `W`;
- на поле 10 уточек;
- на поле 4 постоянных препятствия;
- первым ходит `robot`;
...
- все команды входят в поддерживаемый набор `1, 2, 3, 4, 10, 11, 12, 13`;
...
| --- | --- | --- |
| `unknown_command` | `400` | Есть команда вне поддерживаемого набора |
